...
public class GiantSpider : MonoBehaviour, IDamage
{
    [SerializeField]
                ...
                if (m_angleToPlayer <= m_fieldOfView && m_isPlayerInRange)
                {
                    ...
                    switch (attackIndex)
                    {
                        case 1: // if attackIndex is 1
                            m_animator.SetTrigger("SpiderBossAttack1"); // play the attack animation
                            break;
                        case 2: // if attackIndex is 2
                            m_animator.SetTrigger("SpiderBossAttack2"); // play the attack animation
                            break;
